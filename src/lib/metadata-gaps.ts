...
export const METADATA_GAPS: Record<MetadataGapCode, MetadataGapInfo> = {
  'sin-titulo': {
    label: 'Sin título',
    field: 'dct:title',
    why: 'Sin título el conjunto de datos no se puede buscar ni citar.',
  ...
  'sin-descripcion': {
    ...
    why: 'La descripción es lo que permite decidir si el conjunto de datos sirve antes de descargarlo.',
  ...
  'sin-licencia-identificada': {
    ...
    action: 'Declarar la licencia con un identificador reconocido (CC-BY-4.0 o la licencia IGCYL).',
    axis: 'completitud',
  },
  'sin-organismo': {
  ...
  'sin-idioma': {
    ...
    field: 'dct:language',
    why: 'Los buscadores de datos multilingües lo necesitan para clasificar el conjunto de datos.',
    action: 'Declarar el idioma del conjunto de datos.',
    axis: 'completitud',
  },
  'sin-cobertura': {
    ...
    action: 'Declarar el ámbito territorial que cubre el conjunto de datos.',
    axis: 'completitud',
  },
  'sin-tematica': {
    label: 'Sin temática',
    field: 'dcat:theme',
    why: 'Sin temática el conjunto de datos no aparece en las búsquedas por sector ni se recoge en datos.gob.es.',
    action: 'Asignar al menos una temática de la clasificación sectorial oficial.',
    axis: 'completitud',
  },
  'sin-palabras-clave': {
  ...
  'sin-fecha-actualizacion': {
    ...
    field: 'dct:modified',
    why: 'Es el campo que más falta en todo el catálogo. Sin esta fecha nadie —ni este portal, ni datos.gob.es, ni ningún buscador de datos— puede saber cuándo se refrescó el dato por última vez, así que la actualidad no se puede verificar y el conjunto de datos la pierde en la puntuación aunque se esté actualizando a diario.',
    action: 'Publicar la fecha de última actualización y mantenerla al día en cada revisión.',
    axis: 'actualidad',
  },
  'sin-periodicidad': {
    ...
    action: 'Declarar cada cuánto se actualiza el conjunto de datos.',
    axis: 'actualidad',
  },
  'licencia-restrictiva': {
  ...
  'sin-formato-abierto': {
    ...
    why: 'Publicar solo en formatos propietarios obliga a quien reutiliza a tener el programa concreto que los abre.',
    action: 'Añadir un archivo en CSV, JSON o GeoJSON junto a los existentes.',
    axis: 'apertura',
  },
  'sin-identificador': {
    label: 'Sin identificador persistente',
    field: 'dct:identifier',
    why: 'Un identificador estable permite citar el conjunto de datos y seguirlo aunque cambie su dirección.',
    action: 'Publicar un identificador propio que no cambie con el tiempo.',
    axis: 'recomendacion',
  },
  'sin-punto-contacto': {
    label: 'Sin punto de contacto',
    field: 'dcat:contactPoint',
    why: 'Es a quién escribir para avisar de un error en el dato. Sin él, un fallo detectado por quien reutiliza no llega a quien puede corregirlo.',
    action: 'Publicar un buzón de contacto atendido.',
    axis: 'recomendacion',
  },
};
